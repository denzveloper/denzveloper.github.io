...
Others port is open, but i dont recomended. cause that currenly on trials device may unstable and may be sometime cant be reach, for better use above ports/address.
